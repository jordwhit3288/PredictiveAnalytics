---
title: "Chicago Police Department Analysis"
output: 
...
### Time of Offense VS Arrest Status
...
### Quarter of Year VS Arrest Status

```{r}

# 
# ggplot(chi_new, aes(District, fill = Arrest)) +
#   geom_bar(aes(y=..count../sum(..count..)), position = "dodge")
...
### Offense Location VS Arrest Status 
